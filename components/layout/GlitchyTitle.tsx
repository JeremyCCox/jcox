    ...
    return(
        <div className={'flex relative'}>
            {possibleTitle1.map((title,index)=>{
                return(
                    <h2 className={title===title1?'px-2 md:px-4 top-0 transition-all ease-in duration-500':'absolute px-2 md:px-8 translate-y-[1lh] -z-10 opacity-0 transition-all ease-in duration-500'} key={"title1"+index}>
                        {`${title.title}`}
                    </h2>
                )
            })}
            {possibleTitle2.map((title,index)=>{
                return(
                    <h2 style={title.style} className={title===title2?'absolute translate-x-[130px] md:translate-x-[215px] lg:translate-x-[350px] transition-all ease-in duration-500 -z-10':'absolute translate-x-[130px] md:translate-x-[215px] lg:translate-x-[350px] -z-10 translate-y-[1lh] opacity-0 transition-all ease-in duration-500'} key={"title1"+index}>
                        {`${title.title}`}
                    </h2>
                )
            })}
